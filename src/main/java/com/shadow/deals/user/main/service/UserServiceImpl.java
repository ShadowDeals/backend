...
public class UserServiceImpl implements UserService, CommonUpdateService<User> {
     ...
     */
    @Override
    public Flux<User> findById(UUID id) {
        return Flux.from(userRepository.findById(id))
     ...
     */
    @Override
    public Flux<User> save(User entity) {
        return Flux.from(userRepository.save(entity));
    }
    ...
    public User findByEmail(String email) {
        return Flux.from(userRepository.findByEmail(email))
                .switchIfEmpty(Mono.error(
                                new APIException(
    ...
    public User findByRefreshTokenKey(String refreshTokenKey) {
        return Flux.from(userRepository.findByRefreshTokenKey(refreshTokenKey))
                .switchIfEmpty(Mono.error(
                                new APIException(
     ...
     */
    @Override
    public Flux<User> update(User entity) {
        return Flux.from(userRepository.update(entity));
    }
}