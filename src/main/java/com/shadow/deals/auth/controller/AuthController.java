...
public class AuthController {
    ...
    public MutableHttpResponse<Flux<String>> signup(@Valid @Body SignUpRequestDTO signUpRequestDTO) {
    ...
    public Publisher<MutableHttpResponse<?>> login(@Valid @Body SignInRequestDTO signInRequestDTO,
                                                   HttpRequest<?> request) {
